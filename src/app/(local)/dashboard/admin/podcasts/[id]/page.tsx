...
import { usePodcast, useRealDeletePodcast } from "@/hooks/usePodcastQuery";
...
import { Mic, Trash2, Users, Calendar, FileText, Plus, ArrowLeft } from 'lucide-react';
      ...
      <AdminRoute>
        <div className="min-h-screen bg-slate-50/50 flex items-center justify-center">
          <div className="text-center py-12">
            ...
            <Button
              onClick={() => router.push('/dashboard/admin/podcasts')}
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-base">Gérez le podcast et ses épisodes</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  ...
                  Gérer les épisodes de la plateforme
                </Button>
                <Button
                  ...
                  {podcast.episodes && podcast.episodes.length > 0 ? (
                    <div className="space-y-4">
                      <EpisodeList
                        ...
                        onPlay={playEpisode}
                        onView={(episode) => router.push(`/dashboard/admin/podcasts/${podcastId}/episode/${episode.id}`)}
                        onEdit={(episode) => router.push(`/dashboard/admin/podcasts/${podcastId}/episode/${episode.id}`)}
                        isPlaying={isPlaying}
