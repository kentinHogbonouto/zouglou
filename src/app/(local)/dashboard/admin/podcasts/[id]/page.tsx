...
export default function ArtistPodcastDetailPage() {
  ...
  const handleUpdatePodcast = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/admin/podcasts/${podcastId}`);
    } catch (error) {
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              {!isEditMode && (
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    onClick={() => router.push(`/dashboard/admin/podcasts/${podcastId}?edit=true`)}
              ...
              <CardContent className="p-8">
                <form onSubmit={handleUpdatePodcast} className="space-y-8">
                  ...
                  <div className="flex justify-end gap-4 pt-6 border-t border-slate-200">
                    <Button
                      type="button"
                      onClick={() => router.push(`/dashboard/admin/podcasts/${podcastId}`)}
                    ...
                    {podcast.episodes && podcast.episodes.length > 0 ? (
                      <div className="space-y-4">
                        <EpisodeList
                          ...
                          onEdit={(episode) => router.push(`/dashboard/admin/podcasts/${podcastId}/episode/${episode.id}?edit=true`)}
                          isPlaying={isPlaying}
