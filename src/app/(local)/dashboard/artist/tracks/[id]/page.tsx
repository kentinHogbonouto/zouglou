...
export default function TrackDetailPage() {
  ...
  const handleUpdateSong = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/artist/tracks/${trackId}`);
    } catch (error) {
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => router.push('/dashboard/artist/tracks')}
              ...
              {!isEditMode && (
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    onClick={() => router.push(`/dashboard/artist/tracks/${trackId}?edit=true`)}
                ...
                <CardContent className="p-8">
                  <form onSubmit={handleUpdateSong} className="space-y-8">
                    ...
                    <div className="flex justify-end gap-4 pt-6 border-t border-slate-200">
                      <Button
                        type="button"
                        onClick={() => router.push(`/dashboard/artist/tracks/${trackId}`)}
