...
export default function ArtistPodcastEpisodeDetailPage() {
  ...
  const handleUpdateEpisode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/artist/podcasts/${podcastId}/episode/${episodeId}`);
    } catch (error) {
  ...
  const handleDelete = async () => {
    try {
      ...
      router.push(`/dashboard/artist/podcasts/${podcastId}/episode`);
    } catch (error) {
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              {!isEditMode && (
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button
                    onClick={() => router.push(`/dashboard/artist/podcasts/${podcastId}/episode/${episodeId}?edit=true`)}
              ...
              <CardContent className="p-8">
                <form onSubmit={handleUpdateEpisode} className="space-y-8">
                  ...
                  <div className="flex justify-end gap-4 pt-6 border-t border-slate-200/50">
                    <Button
                      type="button"
                      onClick={() => router.push(`/dashboard/artist/podcasts/${podcastId}/episode/${episodeId}`)}
